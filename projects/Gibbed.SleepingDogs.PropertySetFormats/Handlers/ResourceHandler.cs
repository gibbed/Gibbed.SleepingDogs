...
{
    internal class ResourceHandler : BasicHandler<DataFormats.ResourceHandle>
    {
        internal ResourceHandler()
            : base(21, 40, 4, "qResHandle", "Resource", false)
        {
        }

        protected override DataFormats.ResourceHandle Read(Stream input, Endian endian)
        {
