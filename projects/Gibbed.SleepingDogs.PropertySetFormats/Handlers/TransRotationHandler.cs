...
{
    internal class TransRotationHandler : BasicHandler<DataFormats.TransRotation>
    {
        internal TransRotationHandler()
            : base(27, 64, 4, "Transrotation", "TransRotation", false)
        {
        }

        protected override DataFormats.TransRotation Read(Stream input, Endian endian)
        {
