...
{
    internal class SymbolHandler : BasicHandler<DataFormats.Symbol>
    {
        internal SymbolHandler()
            : base(22, 4, 4, "qSymbol", "Symbol", false)
        {
        }

        protected override DataFormats.Symbol Read(Stream input, Endian endian)
        {
