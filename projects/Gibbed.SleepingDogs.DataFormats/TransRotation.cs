...
namespace Gibbed.SleepingDogs.DataFormats
{
    public struct TransRotation
    {
        ...
        public TransRotation(Vector4 v0, Vector4 v1, Vector4 v2, Vector4 v3)
        {
            this.V0 = v0;
            this.V1 = v1;
            this.V2 = v2;
        ...
        public static TransRotation Read(Stream input, Endian endian)
        {
